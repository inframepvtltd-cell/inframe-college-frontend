  ...
  return (
    <div>
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
            <NavigationMenuTrigger className="bg-yellow-300 text-black focus:bg-yellow-500 focus:text-black">
              <span className="flex items-center gap-1 text-md font-bold font-sans">Study</span>
            </NavigationMenuTrigger>
