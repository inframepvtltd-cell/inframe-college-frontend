...
import { FaPaintBrush, FaMagic, FaPenNib } from "react-icons/fa";
...
export const fashionDesignCurriculum = {
    "1st Year": {
        title: "1st Year",
        ...
        semesters: {
            ...
            "Semester 2": [
                ...
                "Fashion Rendering & Presentation",
    ...
    "2nd Year": {
        ...
        imageAlt: "Advanced fashion design and production",
        semesters: {
            "Semester 3": [
                "Advanced Pattern Making",
                "Fashion Collection Development",
                "Textile Design & Printing",
                "Fashion CAD & Digital Tools",
                "Menswear Design",
    ...
    "3rd Year": {
        ...
        imageAlt: "Specialized fashion design and industry preparation",
        semesters: {
            "Semester 5": [
                "Fashion Brand Development",
                "Luxury Fashion Design",
                "Digital Fashion Marketing",
                "Fashion Styling & Direction",
                ...
                <div id="curriculum" className="max-w-7xl mx-auto px-1 py-2 bg-white">
                    ...
                    <Tabs defaultValue="1st Year" className="w-full">
                        <TabsList className="md:w-full flex flex-wrap h-10 mb-6 bg-zinc-200 rounded-lg p-1 gap-2">
                            {Object.keys(fashionDesignCurriculum).map((year) => (
                                <TabsTrigger
                                    key={year}
                                    value={year}
                        ...
                        {/* Year Content */}
                        {Object.entries(fashionDesignCurriculum).map(([year, data]) => (
...
export default FashionDesignComponent;
