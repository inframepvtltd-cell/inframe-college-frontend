      ...
      <div className="max-w-4xl mx-auto">
        <Card className="bg-white shadow">
          <CardContent className="p-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-8">Delivery & Shipping Policy</h1>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Delivery or Shipping Charges</h2>
              <p className="text-gray-600 mb-4">
                We charge for package Courier Charges applicable all over India. 
                <em className="block mt-2">We also provide free shipping on some products.</em>
              </p>
              <div className="mt-4 space-y-2 text-gray-600">
                <p><strong>Across India:</strong> Rs.50-90 for individual books/subjects</p>
                <p><strong>Outside India:</strong> Depends upon the Country and their rules. For more details contact us at <a href="mailto:hr@inframecollege.org" className="text-blue-600 hover:underline">hr@inframecollege.org</a></p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Estimated Delivery Time</h2>
              <p className="text-gray-600 mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Our Shipping Partners</h2>
              <p className="text-gray-600 mb-4">
              ...
              <p className="text-gray-600">
                We use the services of India Post Speed Post, FEDEX, Blue dart, DHL Etc
              </p>
            </section>
          </CardContent>
        </Card>
