...
const ThankYouPage = () => {
  return (
    <div className={`min-h-screen bg-gradient-to-b my-16 from-white  to-gray-50 flex items-center justify-center p-4 ${poppins.className}`}>
      <div className="max-w-2xl mx-auto text-center">
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-black  md:p-12">
          ...
          <div className="mt-8 text-sm text-gray-500">
            ...
            <p className="font-medium">info@inframecollege.org | +91 9649 9649 37</p>
          </div>
        </div>
      </div>
    </div>
