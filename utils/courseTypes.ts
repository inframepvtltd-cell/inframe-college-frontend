...
export const courseTypes: CourseCategory = {
  "interior-design": [
    {
      ...
      description:
        "Transform spaces and shape experiences through our comprehensive design program. Learn from industry experts and build a successful career in interior design.",
      content:
  ...
  "fashion-design": [
    {
      ...
      description:
        "Shape the future of fashion through innovative design and creative expression.",
      content:
  ...
  "graphic-design": [
    {
      ...
      duration: "4 Years Full-Time",
      description:
        "Create compelling visual communications through innovative design.",
      software: [
    ...
    },
    {
      ...
      whatYouWillLearn: [],
      description:
        "Master both creative and technical aspects of graphic design.",
      curriculum: {
        "1st Year": {
          image: "https://images.unsplash.com/photo-1617103996702-96ff29b1c467",
    ...
    },
    {
      ...
      whatYouWillLearn: [],
      description:
        "Quick, intensive training in essential graphic design skills.",
      curriculum: {
        "1st Year": {
          image: "https://images.unsplash.com/photo-1617103996702-96ff29b1c467",
  ...
  "uiux-design": [
    {
      ...
      duration: "4 Years Full-Time",
      description:
        "Create seamless digital experiences through user-centered design.",
      software: [
  ...
  "animation-vfx": [
    {
      ...
      duration: "4 Years Full-Time",
      description:
        "Master the art of animation and VFX to create captivating visual experiences.",
      software: [
        { name: "Maya", src: "/software logos/pngegg (28).png" },
    ...
    },
    {
      ...
      whatYouWillLearn: [],
      description:
        "Jumpstart your career in animation and VFX with hands-on training.",
      curriculum: {
        "1st Year": {
          image: "https://images.unsplash.com/photo-1617103996702-96ff29b1c467",
    ...
    {
      content:
        "The Two Year Diploma in Animation and VFX is a comprehensive program that covers all aspects of animation and visual effects production. Students will dive deep into 2D and 3D animation, compositing, advanced VFX software, and industry-standard workflows. This program ensures that students are well-prepared for entry-level positions in animation and VFX production.",
      value: "diploma2",
      label: "2 Year Diploma in Animation and VFX",
      title: "2 Year Diploma in Animation and VFX",
      duration: "2 Years Intensive",
      description:
        "Get industry-ready with an in-depth, hands-on program in animation and VFX.",
      software: [
        { name: "Maya", src: "/software logos/pngegg (28).png" },
        { name: "3DS Max", src: "/software logos/pngegg (19).png" },
        { name: "Blender", src: "/software logos/pngegg (30).png" },
  ...
  "digital-marketing": [
    {
      content:
        "The Bachelor of Vocation (B.VOC) in Digital Marketing is a comprehensive three-year program focused on modern marketing strategies. Students learn social media marketing, SEO, content marketing, and data analytics. The curriculum includes hands-on projects, industry certifications, and real-world campaign management experience.",
      value: "bvoc",
      label: "B.VOC in Digital Marketing",
      title: "B.VOC in Digital Marketing",
      duration: "3 Years Full-Time",
      description:
        "Master the art of digital marketing and online brand building.",
      whatYouWillLearn: [
        {
        ...
        },
        {
          ...
          description:
            "Develop strategic content plans and marketing materials",
        },
        {
    ...
    {
      content:
        "The One Year Diploma in Digital Marketing provides intensive training in digital marketing tools and strategies. Students learn social media management, SEO techniques, email marketing, and basic analytics. The program includes practical projects and preparation for industry certifications.",
      value: "diploma1",
    ...
    {
      content:
        "The Six Month Certificate course in Digital Marketing offers focused training in key digital marketing skills. Students learn the fundamentals of online marketing, including social media, SEO, and basic analytics. Perfect for quick skill development and career transition.",
      value: "certificate6",
  ...
  "fine-arts": [
    ...
    },
    {
      ...
      duration: "3 Years Full-Time",
      description:
        "Learn the art of visual storytelling through our comprehensive BFA in Visual Communication. Create impactful designs that speak to audiences.",
      software: [
        { name: "Photoshop", src: "/software logos/pngegg (24).png" },
        { name: "Adobe Illustrator", src: "/software logos/pngegg (25).png" },
      ],
    ...
    },
    {
      ...
      duration: "3 Years Full-Time",
      description:
        "Explore the world of three-dimensional art with a BFA in Sculpture. Develop your sculptural skills and artistic expression.",
      software: [
        { name: "Photoshop", src: "/software logos/pngegg (24).png" },
        { name: "Adobe Illustrator", src: "/software logos/pngegg (25).png" },
      ],
  ...
  "advertising-marketing": [
    {
      ...
      duration: "3 Years Full-Time",
      description:
        "Master the art and science of modern marketing and advertising. Learn to create impactful campaigns and build successful brands in the digital age.",
      software: [
        { name: "AutoCAD", src: "/logos/pngegg (17).png" },
        { name: "SketchUp", src: "/logos/pngegg (18).png" },
        { name: "3dsMax", src: "/logos/pngegg (19).png" },
