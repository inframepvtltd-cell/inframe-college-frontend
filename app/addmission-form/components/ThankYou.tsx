...
import { PartyPopper, CheckCircle, Download, Mail, Phone, Home } from "lucide-react";
...
export default function ThankYouStep({
  ...
  useEffect(() => {
    ...
    const checkSubmission = () => {
      ...
      if (userEmail) {
        const savedApp = localStorage.getItem(`application_${userEmail}`);
        if (!savedApp) {
          // Redirect back to form if no submission found
