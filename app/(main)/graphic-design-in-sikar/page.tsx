...
export const metadata = {
    title: "Graphic Design Course in Sikar | Inframe School",
    description: "Master digital design tools and creative skills with the Graphic Design Course in Sikar by Inframe School."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <GraphicDesignComponent
                ...
                description="Design with purpose through our Graphic Design Course."
