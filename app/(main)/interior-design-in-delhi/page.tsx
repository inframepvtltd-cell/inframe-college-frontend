...
export const metadata = {
    title: "Interior Design Course in Delhi | Inframe School",
    description: "Build professional design skills with the Interior Design Course in Delhi by Inframe School. Learn tools, software, and creativity."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <InteriorDesignComponent
                ...
                description="Unlock your creative potential through an immersive Interior Design Course.
"
