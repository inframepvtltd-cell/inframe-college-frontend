...
export const metadata = {
    title: "Graphic Design Course in Indore | Inframe School",
    description: "Build your design career with software training and creative skills through the Graphic Design Course in Indore."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <GraphicDesignComponent
                ...
                description="Train with experts in a premium Graphic Design Course.
" 
