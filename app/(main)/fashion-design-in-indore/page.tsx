...
export const metadata = {
    title: "Fashion Design Course in Indore | Inframe School",
    description: "Build strong fashion design skills with Inframe School’s Fashion Design Course in Indore. Ideal for creative learners."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <FashionDesignComponent
                ...
                content1="At Inframe, you can choose from multiple fashion design programs like B.Des in Fashion Design, BVOC, B.Sc, One-Year Diploma, and Three-Year Diploma. If you are searching for a Fashion Design Course in Indore, these programs help you build strong creative and technical skills. By the end of the course, you will have a professional portfolio and the confidence to work in the fashion industry."
                ...
                description="Build a runway-ready career with our professional Fashion Design Course."
