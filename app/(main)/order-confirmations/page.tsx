...
export default function ThankYouPage() {
    ...
    useEffect(() => {
        ...
        const amount = Number(sessionStorage.getItem("purchase_amount"));
        const eventId = sessionStorage.getItem("purchase_event_id");

        if (!amount || amount <= 0 || !eventId) return;
        ...
        console.log("🔥 Meta Purchase fired:", amount);

        // prevent duplicate firing
        sessionStorage.removeItem("purchase_amount");
