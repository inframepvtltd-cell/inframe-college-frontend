...
export const metadata = {
    title: "Digital Marketing Course in Delhi – Professional Training | Inframe School",
    description: "Join Inframe School’s Digital Marketing Course in Delhi and master tools, branding, and digital creativity. Learn from industry experts and build a professional portfolio for a successful career."
};
