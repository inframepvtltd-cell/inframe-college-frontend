...
export const metadata = {
    title: "Interior Design Course in Sikar | Inframe School",
    description: "Build professional design skills with Inframe School’s Interior Design Course in Sikar. Ideal for creative and career-focused learners."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <InteriorDesignComponent
                ...
                description="Learn to create meaningful interiors with a thoughtfully structured Interior Design Course.
"
