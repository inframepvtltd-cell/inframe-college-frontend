...
export const metadata = {
    title: "Interior Design Course in Ajmer | Inframe School",
    description: "Join the Interior Design Course in Ajmer by Inframe School to master modern tools, design concepts, and real project experience."
};
