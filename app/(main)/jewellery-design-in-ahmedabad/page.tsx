...
export const metadata = {
    title: "Jewellery Design Course in Ahmedabad – Professional Training | Inframe School",
    description: "Join Inframe School’s Jewellery Design Course in Ahmedabad and master design tools, branding, and digital creativity. Learn from industry experts and build a professional portfolio for a successful design career."
};
