...
export const metadata = {
    title: "Interior Design Course in Pali – Professional Training | Inframe School",
    description: "Join Inframe School’s Interior Design Course in Pali and master design tools, branding, and digital creativity. Learn from industry experts and build a professional portfolio for a successful design career."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <InteriorDesignComponent
                title=" Interior Design Course in Pali"
