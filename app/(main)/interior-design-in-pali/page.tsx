...
export const metadata = {
    title: "Interior Design Course in Pali | Inframe School",
    description: "Learn creative and technical interior design skills with Inframe School’s Interior Design Course in Pali. Build a strong design career."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <InteriorDesignComponent
                ...
                description="Craft visually stunning spaces through an advanced Interior Design Course."
