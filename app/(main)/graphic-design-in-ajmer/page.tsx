...
export const metadata = {
    title: "Graphic Design Course in Ajmer – Professional Training | Inframe School",
    description: "Join Inframe School’s Graphic Design Course in Ajmer and master design tools, branding, and digital creativity. Learn from industry experts and build a professional portfolio for a successful design career."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <GraphicDesignComponent
                title="Graphic Design Course in Ajmer"
