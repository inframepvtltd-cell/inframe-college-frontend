...
export const metadata = {
    title: "Graphic Design Course in Ajmer | Inframe School",
    description: "Build creative and technical design skills with Inframe School’s Graphic Design Course in Ajmer."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <GraphicDesignComponent
                ...
                description="Shape creative stories with a professional Graphic Design Course.
" 
