...
export const metadata = {
    ...
    description: "Join Inframe School’s Jewelery Design Course in Agra and master design tools, branding, and digital creativity. Learn from industry experts and build a professional portfolio for a successful design career."
};
