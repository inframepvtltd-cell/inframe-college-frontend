                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 text-sm mt-1">
                      <strong>This form is for:</strong>{" "}
                      {CATEGORIES.slice(0, 5).join(", ")}
                    </p>
                    <p className="text-yellow-700 text-sm mt-2 font-semibold">
                      ⚠️ This form is NOT for career opportunities, job
                      applications, or student admissions. Please use the links
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        maxLength={10}
                        className={`h-12 ${errors.phone_number ? "border-red-500" : "border-gray-300"}`}
                      />
                    )}
                  />
                  {errors.phone_number && (
