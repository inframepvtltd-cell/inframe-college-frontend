...
export const metadata = {
    title: "UI UX Design Course in Bikaner | Inframe School",
    description: "Build design thinking and digital interface skills with the UI UX Design Course in Bikaner by Inframe School."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <UIUXDesignComponent
                ...
                content1="At Inframe, you can choose from multiple UI UX design programs such as B.Des in UI UX Design, BVOC, B.Sc, One-Year Diploma, and Three-Year Diploma. If you are searching for a UI UX Design Course in Bikaner, these programs are designed to help you build strong creative, analytical, and technical skills required in the digital design industry. By the end of the course, you will have a professional portfolio and the confidence to design user-friendly digital experiences for websites, mobile apps, and software products."
                ...
                description="Build design-thinking skills through a UI UX Course.
"
                index={0}
                category=""
