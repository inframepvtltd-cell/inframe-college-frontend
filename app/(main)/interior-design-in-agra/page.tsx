...
export const metadata = {
    title: "Interior Design Course in Agra | Inframe School",
    description: "Join Inframe School’s Interior Design Course in Agra to learn space planning, materials, lighting, and modern design techniques."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <InteriorDesignComponent
                ...
                description="Elevate your creative future with a world-class Interior Design Course.
"
