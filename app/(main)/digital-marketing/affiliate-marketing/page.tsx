...
export const metadata = {
    title: "Affiliate Marketing Course: Build Profitable Systems",
    description: "Learn how to pick winning niches, choose legit programs, create funnels, and drive consistent traffic so your affiliate income is based on strategy, not luck.",
};
