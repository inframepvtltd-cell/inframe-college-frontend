...
export const metadata = {
    title: "UIUX Design Course in Delhi – Professional Training | Inframe School",
    description: "Join Inframe School’s UIUX Design Course in Delhi and master design tools, branding, and digital creativity. Learn from industry experts and build a professional portfolio for a successful design career."
};
