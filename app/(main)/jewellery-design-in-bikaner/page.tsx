...
export const metadata = {
    title: "Jewellery Design Course in Bikaner – Professional Training | Inframe School",
    description: "Join Inframe School’s Jewellery Design Course in Bikaner and master design tools, branding, and digital creativity. Learn from industry experts and build a professional portfolio for a successful design career."
};
