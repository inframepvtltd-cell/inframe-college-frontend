...
export const metadata = {
    title: "Interior Design Course in Lucknow | Inframe School",
    description: "Learn creative and technical interior design skills with Inframe School’s Interior Design Course in Lucknow. Build a strong portfolio."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <InteriorDesignComponent
                ...
                description="Design beyond boundaries with an innovative Interior Design Course.
"
