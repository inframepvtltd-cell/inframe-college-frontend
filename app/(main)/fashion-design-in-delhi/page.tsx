...
export const metadata = {
    title: "Fashion Design Course in Delhi | Inframe School",
    description: "Learn fashion sketching, styling, and garment making with the Fashion Design Course in Delhi by Inframe School."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <FashionDesignComponent
                title="Fashion Design Course in Delhi"
                duration="4 Years Full-Time"
                content1="At Inframe, you can choose from multiple fashion design programs like B.Des in Fashion Design, BVOC, B.Sc, One-Year Diploma, and Three-Year Diploma. If you are searching for a Fashion Design Course in Delhi, these programs help you build strong creative and technical skills. By the end of the course, you will have a professional portfolio and the confidence to work in the fashion industry."
...
"
                description="Explore fabrics, form, and finesse with a curated Fashion Design Course.
"
