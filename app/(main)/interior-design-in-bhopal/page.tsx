...
export const metadata = {
    title: "Interior Design Course in Bhopal | Inframe School",
    description: "Learn modern interior design tools and concepts with Inframe School’s Interior Design Course in Bhopal. Start your design journey."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <InteriorDesignComponent
                title="Interior Design Course in Bhopal"
                duration="4 Years Full-Time"
                description="Step into the world of luxury design with our Interior Design Course.
"
