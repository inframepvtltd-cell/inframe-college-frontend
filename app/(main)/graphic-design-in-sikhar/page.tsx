...
export const metadata = {
    title: "Graphic Design Course in Sikhar – Learn Digital Design | Inframe School",
    description: "Start your creative journey with Inframe School’s Graphic Design Course in Sikhar. Get hands-on training in visual design, editing tools, and branding to prepare for top design jobs in India."
};
    ...
    return (
        <div className="bg-white text-black mt-20">
            <GraphicDesignComponent
                title="Graphic Design Course in Sikhar"
